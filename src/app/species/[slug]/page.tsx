...
const FISH_DATA: Record<string, FishData> = {
  ...
  grayling: {
    ...
    image: '/fish_catalog/graling.jpeg',
    stats: [
    ...
    <div className="min-h-screen" style={{ background: '#F3EDE4' }}>
      ...
      <footer style={{ background: '#05101A' }}>
        ...
        >
          ...
          <Link
            href="/"
            className="text-[12px] f-body hover:opacity-60 transition-opacity"
