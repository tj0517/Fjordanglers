 ...
 * Delegates all form logic to the ResetPasswordForm Client Component,
 * which reads the recovery token from the URL hash on the client side.
 */
...
export const metadata: Metadata = {
  title: 'Set new password — FjordAnglers',
  description: 'Set a new password for your FjordAnglers account.',
}
