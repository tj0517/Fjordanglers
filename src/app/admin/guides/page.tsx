...
export default async function AdminGuidesPage({
  ...
  const [{ data: guides }, { data: expCounts }] = await Promise.all([
    supabase
      .from('guides')
      .select('id, full_name, country, city, status, is_beta_listing, user_id, invite_email, avatar_url, fish_expertise, created_at, stripe_account_id, stripe_charges_enabled, stripe_payouts_enabled')
      ...
      >
        <div className="overflow-x-auto">
          ...
          <div
            ...
            style={{
              gridTemplateColumns: '2.2fr 1.4fr 0.9fr 0.9fr 0.5fr 1.3fr',
              borderBottom: '1px solid rgba(10,46,77,0.07)',
              background: 'rgba(10,46,77,0.02)',
              minWidth: '860px',
            }}
          >
            {['Guide', 'Status', 'Account', 'Stripe', 'Trips', 'Actions'].map(col => (
          ...
          {filteredGuides.length === 0 ? (
            ...
            <div className="divide-y" style={{ borderColor: 'rgba(10,46,77,0.05)', minWidth: '860px' }}>
              {filteredGuides.map((guide) => {
                ...
                return (
                  <div
                    ...
                    style={{ gridTemplateColumns: '2.2fr 1.4fr 0.9fr 0.9fr 0.5fr 1.3fr' }}
                  >
                    {/* Guide */}
