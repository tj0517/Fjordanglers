...
| FA-1.08 | Wycięcie martwego kodu — paczka 2: komponenty i trasy, lint do zera, `knip`+`lint` blokują w CI (trudność podniesiona do L po decyzji o pełnym zerze lintu; model Opus zatwierdzony przez tj 20 IX) | L | opus | review | FA-1.07 |
