# AGENT_RULES — reguły starego agenta (v1)

Źródło: `src/lib/ai/inquiry-agent.ts` w commicie `263de15f^` (stan tuż przed FA-1.25, PR #90), linie 41–299: `AGENT_RULES`, `CLOSING_MESSAGE`, `WRAPPING_UP_MESSAGE`.
Archiwizowane 2026-09-23. Podstawa wpisu `instructions` w FA-1.17 — nie pisać od zera.
